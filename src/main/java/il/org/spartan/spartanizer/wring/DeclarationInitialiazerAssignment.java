 ...
 * @author Yossi Gil
 * @since 2015-08-07 */
public final class DeclarationInitialiazerAssignment extends Wring.VariableDeclarationFragementAndStatement implements Kind.Collapse {
  @Override String description(final VariableDeclarationFragment ¢) {
