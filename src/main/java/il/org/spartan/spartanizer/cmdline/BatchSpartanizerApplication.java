...
import il.org.spartan.spartanizer.cmdline.Application.*;
 ...
 * It does everything BatchSpartanizer does, but using the {@link EventApplicator}
 * @author Matteo Orru'
 * @year 2016 */
...
//  private EventApplicator e = new EventApplicator();
  ...
  private int optRounds; // passes() look at EventApplicator
