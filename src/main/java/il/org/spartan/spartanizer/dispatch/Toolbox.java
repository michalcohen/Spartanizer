...
public class Toolbox {
  ...
  @SuppressWarnings({ "synthetic-access", "rawtypes" }) private static final Map<Class<? extends Tipper>, TipperGroup> categoryMap = new HashMap<Class<? extends Tipper>, TipperGroup>() {
