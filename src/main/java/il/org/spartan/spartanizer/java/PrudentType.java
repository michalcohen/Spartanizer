...
public enum PrudentType {
   ...
   * @param s
   * @return The specified PrudentType, PrudentType.NOTHING as default. */
  public static PrudentType prudentGenerateFromTypeName(final String s) {
    return typeSwitch(s, PrudentType.NOTHING);
  }
