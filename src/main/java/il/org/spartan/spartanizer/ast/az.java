...
public enum az {
  ...
  public static ArrayInitializer arrayInitializer(final Expression $) {
    return iz.not($, ARRAY_INITIALIZER) ? null : (ArrayInitializer) $;
  }
  ...
  public static Assignment assignment(final ASTNode $) {
    return iz.not($, ASSIGNMENT) ? null : (Assignment) $;
  }
  ...
  public static Block block(final ASTNode $) {
    return iz.not($, BLOCK) ? null : (Block) $;
  }
  ...
  public static BooleanLiteral booleanLiteral(final ASTNode $) {
    return iz.not($, BOOLEAN_LITERAL) ? null : (BooleanLiteral) $;
  }
  ...
  public static EnhancedForStatement enhancedFor(final ASTNode $) {
    return iz.not($, ENHANCED_FOR_STATEMENT) ? null : (EnhancedForStatement) $;
  }
  ...
  public static ExpressionStatement expressionStatement(final ASTNode $) {
    return iz.not($, EXPRESSION_STATEMENT) ? null : (ExpressionStatement) $;
  }

  public static FieldDeclaration fieldDeclaration(final ASTNode ¢) {
    return iz.not(¢, FIELD_DECLARATION) ? null : (FieldDeclaration) ¢;
  }
  ...
  public static ForStatement forStatement(final ASTNode $) {
    return iz.not($, FOR_STATEMENT) ? null : (ForStatement) $;
  }
  ...
  public static IfStatement ifStatement(final ASTNode $) {
    return iz.not($, IF_STATEMENT) ? null : (IfStatement) $;
  }
  ...
  public static InstanceofExpression instanceofExpression(final Expression $) {
    return iz.not($, INSTANCEOF_EXPRESSION) ? null : (InstanceofExpression) $;
  }

  public static LambdaExpression lambdaExpression(final ASTNode $) {
    return iz.not($, LAMBDA_EXPRESSION) ? null : (LambdaExpression) $;
  }
  ...
  public static MethodRef methodRef(final ASTNode ¢) {
    return iz.not(¢, MEMBER_REF) ? null : (MethodRef) ¢;
  }
  ...
  public static ParenthesizedExpression parenthesizedExpression(final Expression $) {
    return iz.not($, PARENTHESIZED_EXPRESSION) ? null : (ParenthesizedExpression) $;
  }
  ...
  public static ReturnStatement returnStatement(final ASTNode $) {
    return iz.not($, RETURN_STATEMENT) ? null : (ReturnStatement) $;
  }
   ...
   * @return
   */
  public static SingleVariableDeclaration singleVariableDeclaration(VariableDeclaration $) {
    return !iz.is($, SINGLE_VARIABLE_DECLARATION) ? null : (SingleVariableDeclaration) $;
  }
  ...
  public static StringLiteral stringLiteral(final ASTNode $) {
    return iz.not($, STRING_LITERAL) ? null : (StringLiteral) $;
  }
  ...
  public static ThrowStatement throwStatement(final ASTNode $) {
    return iz.not($, THROW_STATEMENT) ? null : (ThrowStatement) $;
  }
  ...
  public static VariableDeclarationExpression variableDeclarationExpression(final ASTNode $) {
    return iz.not($, VARIABLE_DECLARATION_EXPRESSION) ? null : (VariableDeclarationExpression) $;
  }
  ...
  public static VariableDeclarationStatement variableDeclrationStatement(final ASTNode $) {
    return iz.not($, VARIABLE_DECLARATION_STATEMENT) ? null : (VariableDeclarationStatement) $;
  }
  ...
  public static WildcardType wildcardType(final ASTNode $) {
    return iz.not($, WILDCARD_TYPE) ? null : (WildcardType) $;
  }
}
