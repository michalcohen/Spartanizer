...
public interface wizard {
  ...
  // String array contains all primitive class 
  @SuppressWarnings("serial") static final Set<String> boxedTypes = new LinkedHashSet<String>() {
    {
      for (final String ¢ : new String[] { //
          "Boolean", //
          "Byte", //
          "Character", //
          "Double", //
  ...
  // String array contains the names of all primitive boxed types, and all remaining value types (currently only String) 
  @SuppressWarnings("serial") static final Set<String> valueTypes = new LinkedHashSet<String>(boxedTypes) {
    {
      for (final String ¢ : new String[] { //
          "String", //
      }) {
...
/** This list was generated by manually editing the original list at
  ...
  @SuppressWarnings("serial") static final Map<InfixExpression.Operator, Assignment.Operator> infix2assign = new HashMap<InfixExpression.Operator, Assignment.Operator>() {
    {
   ...
   * {@link Assignment.Operator}. */
  @SuppressWarnings("serial") static final Map<Assignment.Operator, InfixExpression.Operator> assign2infix = new HashMap<Assignment.Operator, InfixExpression.Operator>() {
    {
