...
public interface iz {
  ...
  static boolean literal(final ASTNode ¢, final double d) {
    ...
    if (token == null || LiteralParser.of(token) != type.Primitive.Certain.DOUBLE)
      return false;
    return new iz() {
    }.parsesTo(token, d);
  }
  ...
  static boolean literal(final ASTNode ¢, final int i) {
    ...
    if (numberLiteral == null)
      return false;
    final String token = numberLiteral.getToken();
    if (token == null || LiteralParser.of(token) != type.Primitive.Certain.INT)
      return false;
    return new iz() {
    }.parsesTo(token, i);
  }
  ...
  static boolean literal(final ASTNode ¢, final long l) {
    ...
    if (numberLiteral == null)
      return false;
    final String token = numberLiteral.getToken();
    if (token == null || LiteralParser.of(token) != type.Primitive.Certain.LONG)
      return false;
    return new iz() {
    }.parsesTo(token, l);
  }
