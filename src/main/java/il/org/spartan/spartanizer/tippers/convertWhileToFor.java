...
/// ** @author Dor Ma'ayan
// * @since 2016-09-23 */
// public class convertWhileToFor extends ReplaceCurrentNode<WhileStatement>
...
// if (iz.assignment(lastStatement) || iz.incrementOrDecrement(lastStatement) ||
// iz.expressionStatement(lastStatement)) {
