 ...
 * @author Dor Ma'ayan
 * @since 2016-09-09 */
public final class BlockBreakToReturnInfiniteWhile extends CarefulTipper<WhileStatement> implements Kind.Collapse {
  ...
  @Override public Tip tip(final WhileStatement b) {
