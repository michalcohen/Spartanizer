 ...
 * @author Yossi Gil
 * @since 2015-07-29 */
public final class InterfaceClean extends Wring.RemoveModifier<TypeDeclaration> implements Kind.SyntacticBaggage {
  @Override String description(final TypeDeclaration ¢) {
    return "Remove redundant 'abstract'/'static' modifier from interface " + ¢.getName();
  }

  @Override boolean canMake(final TypeDeclaration ¢) {
    return ¢.isInterface();
  }
