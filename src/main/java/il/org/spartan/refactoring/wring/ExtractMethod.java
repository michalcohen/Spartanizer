...
public class ExtractMethod extends Spartanization {
  ...
  @SuppressWarnings("unused") @Override protected ASTVisitor collect(final List<Suggestion> $, final CompilationUnit u) {
    // TODO Ofir: No opportunities for now, if it's 2016 and not added yet,
    // blame
    return new ASTVisitor() {
      @Override public boolean visit(final MethodDeclaration d) {
        $.add(new Suggestion("Extract method", d) {
  ...
  @Override protected final void fillRewrite(@SuppressWarnings("unused") final ASTRewrite __, final CompilationUnit u, @SuppressWarnings("unused") final IMarker m) {
