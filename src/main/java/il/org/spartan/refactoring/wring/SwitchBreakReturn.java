...
public class SwitchBreakReturn extends Wring.MultipleReplaceToNextStatement<SwitchStatement> implements Kind.ConsolidateStatements {
  ...
  @SuppressWarnings("unchecked") @Override ASTRewrite go(final ASTRewrite r, final SwitchStatement s, final Statement next, final TextEditGroup g, final List<ASTNode> bss, final List<ASTNode> crs) {
