...
interface type {
  ...
  default Primitive.Uncertainety asPrimitiveDoubt() {
    return null;
  }

  default boolean canB(@SuppressWarnings("unused") final Primitive.Uncertainety __) {
    return false;
  }
  ...
  interface Primitive {
    ...
    public enum Uncertainety {
      ...
      // Certain types
      NULL("null", "when it is certain to be null: null, (null), ((null)), etc. but nothing else"), BYTE("byte",
          "must be byte: (byte)1, nothing else"), //
      ...
      ;
      /** @param x JD
       * @return The most specific Type information that can be deduced about
       *         the expression, or {@link #NOTHING} if it cannot decide. Will
       *         never return null */
      public static Uncertainety prudent(final Expression x) {
        return prudent(x, null, null);
      }

      @SuppressWarnings("unused") static Uncertainety axiom(final boolean x) {
        return BOOLEAN;
      }

      // from here on is the axiom method used for testing of Doubt. see issue
      // #105 for more details
      @SuppressWarnings("unused") static Uncertainety axiom(final byte x) {
        return BYTE;
      }

      @SuppressWarnings("unused") static Uncertainety axiom(final char x) {
        return CHAR;
      }

      @SuppressWarnings("unused") static Uncertainety axiom(final double x) {
        return DOUBLE;
      }

      @SuppressWarnings("unused") static Uncertainety axiom(final float x) {
        return FLOAT;
      }

      @SuppressWarnings("unused") static Uncertainety axiom(final int x) {
        return INT;
      }

      @SuppressWarnings("unused") static Uncertainety axiom(final long x) {
        return LONG;
      }

      @SuppressWarnings("unused") static Uncertainety axiom(final Object o) {
        return NOTHING;
      }

      @SuppressWarnings("unused") static Uncertainety axiom(final short x) {
        return SHORT;
      }

      @SuppressWarnings("unused") static Uncertainety axiom(final String x) {
        return STRING;
      }
       ...
       * InfixExpression that has extended operand. The order of the type's
       * should much the order of the operands returned by
       * extract.allOperands(), and for any operand whose type is unknown, there
       * should be a null. The list won't be used if the size of the list
       * doesn't match that of extract.allOperands().
       * @param ts list of types of operands. Must be at least of size 2 */
      static Uncertainety prudent(final Expression x, final List<Uncertainety> ts) {
        assert ts.size() >= 2;
       ...
       * type for a single operand expression. The call kind(e,null) is
       * equivalent to kind(e) */
      static Uncertainety prudent(final Expression x, final Uncertainety t) {
      ...
      static Uncertainety prudent(final Expression x, final Uncertainety t1, final Uncertainety t2) {
        final List<Uncertainety> ¢ = new ArrayList<>();
        ¢.add(t1);
        ¢.add(t2);
        return prudent(x, ¢);
      }

      private static Uncertainety conditionalWithNoInfo(final Uncertainety t) {
        switch (t) {
          case BYTE:
          case SHORT:
          case CHAR:
      ...
      private static Uncertainety prudentType(final Assignment x, final Uncertainety t) {
        final Uncertainety $ = t != null ? t : prudent(x.getLeftHandSide());
        return !$.isNoInfo() ? $ : prudent(x.getRightHandSide()).isNumeric() ? NUMERIC : prudent(x.getRightHandSide());
      }

      private static Uncertainety prudentType(final CastExpression x) {
        return typeSwitch("" + step.type(x), BAPTIZED);
      }

      private static Uncertainety prudentType(final ClassInstanceCreation c) {
        return typeSwitch("" + c.getType(), NONNULL);
      }

      private static Uncertainety prudentType(final ConditionalExpression x, final Uncertainety t1, final Uncertainety t2) {
        final Uncertainety $ = t1 != null ? t1 : prudent(x.getThenExpression());
        final Uncertainety ¢2 = t2 != null ? t2 : prudent(x.getElseExpression());
      ...
      private static Uncertainety prudentType(final InfixExpression x, final List<Uncertainety> ts) {
        ...
        Uncertainety $ = lisp.first(¢).underBinaryOperator(o, lisp.second(¢));
        lisp.chop(lisp.chop(¢));
        while (!¢.isEmpty()) {
      ...
      private static Uncertainety prudentType(final MethodInvocation i) {
        return "toString".equals(i.getName() + "") && i.arguments().isEmpty() ? STRING : NOTHING;
      }

      private static Uncertainety prudentType(final NumberLiteral l) {
      ...
      private static Uncertainety prudentType(final ParenthesizedExpression x, final Uncertainety t) {
        return t != null ? t : prudent(extract.core(x));
      }

      private static Uncertainety prudentType(final PostfixExpression x, final Uncertainety t1) {
        return (t1 != null ? t1 : prudent(x.getOperand())).asNumeric(); // see
                                                                        // testInDecreamentSemantics
      }

      private static Uncertainety prudentType(final PrefixExpression x, final Uncertainety t1) {
        return (t1 != null ? t1 : prudent(x.getOperand())).under(x.getOperator());
      }

      private static Uncertainety typeSwitch(final String s, final Uncertainety $) {
        switch (s) {
          case "byte":
          case "Byte":
            return BYTE;
      ...
      Uncertainety(final String name, final String description) {
        this.name = name;
      ...
      private Uncertainety asNumeric() {
      ...
      private Uncertainety asNumericUnderOperation() {
       ...
       *         case it cannot decide */
      private Uncertainety under(final PrefixExpression.Operator o) {
        assert o != null;
      ...
      private Uncertainety underBinaryOperator(final InfixExpression.Operator o, final Uncertainety k) {
        if (o == wizard.PLUS2)
          return underPlus(k);
       ...
       *         decide */
      private Uncertainety underBitwiseOperation(final Uncertainety k) {
        return k == this ? k
       ...
       *         {@link #INTEGRAL} or {@link BOOLEANINTEGRAL}, in case it cannot
       *         decide */
      private Uncertainety underBitwiseOperationNoInfo() {
        return this == BOOLEAN ? BOOLEAN : !isIntegral() ? BOOLEANINTEGRAL : this == LONG ? LONG : INTEGRAL;
      }

      private Uncertainety underIntegersOnlyOperator(final Uncertainety k) {
        final Uncertainety ¢1 = asIntegralUnderOperation();
        final Uncertainety ¢2 = k.asIntegralUnderOperation();
       ...
       *         decide */
      private Uncertainety underNumericOnlyOperator(final Uncertainety k) {
        if (!isNumeric())
        ...
        final Uncertainety $ = k.asNumericUnderOperation();
        assert $ != null;
        assert $.isNumeric() : this + ": is for some reason not numeric ";
       ...
       *         {@link #ALPHANUMERIC}, in case it cannot decide */
      private Uncertainety underPlus(final Uncertainety k) {
