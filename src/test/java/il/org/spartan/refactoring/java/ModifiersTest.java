...
public class ModifiersTest {
  ...
  @Test public void modifierUse_1() {
  ...
  @Test public void modifierUse_23() {
    azzert.that(Modifiers.find("final").compareTo(Modifiers.FINAL), is(0));
  }
