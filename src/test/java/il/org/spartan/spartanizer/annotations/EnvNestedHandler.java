...
public final class EnvNestedHandler extends ENVTestEngineAbstract {
  ...
  /**
   * Manual testing mode, to test the test engine. Comparing annotations with provided set, instead of a Set generated by Environment. 
   * Used to test the test engine itself.
   * @param ¢ - Node that will be searched for suitable annotations.
   * @param es - Set to compare against.
   */
  public EnvNestedHandler(final ASTNode ¢, LinkedHashSet<Entry<String,Information>> es) {
   ...
   * @param es
   */
  public EnvNestedHandler(final String ¢, LinkedHashSet<Entry<String,Information>> es) {
    assert es != null : "The provided Set for manual testing is null!";
    userProvidedSet = es;
    n = getCompilationUnit(¢);
    runTest();
