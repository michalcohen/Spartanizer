...
public final class EnvFlatHandler extends ENVTestEngineAbstract {
   ...
   */
  public EnvFlatHandler(final ASTNode ¢, LinkedHashSet<Entry<String,Information>> es) {
   ...
   * @param es
   */
  public EnvFlatHandler(final String ¢, LinkedHashSet<Entry<String,Information>> es) {
    assert es != null : "The provided Set for manual testing is null!";
    userProvidedSet = es;
    n = getCompilationUnit(¢);
    runTest();
