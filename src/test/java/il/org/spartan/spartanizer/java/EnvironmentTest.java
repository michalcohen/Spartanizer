...
@Ignore public class EnvironmentTest {
  ...
  @Test public void EngineTestFlatUnordered01() {
    ...
    final EnvFlatHandler e = new EnvFlatHandler($);
    // ENVTestEngineAbstract.getCompilationUnit("/il.org.spartan.spartanizer/src/test/java/il/org/spartan/refactoring/java/EnvironmentCodeExamples.java");
    // ENVTestEngineAbstract.getCompilationUnit("il.org.spartan.spartanizer.java.EnvironmentCodeExamples.java");
    // e.runTest();
    s.add(new MapEntry<>("str", new Information(PrudentType.axiom("String"))));
    e.compareOutOfOrder(s);
  }
