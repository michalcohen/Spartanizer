...
@SuppressWarnings({ "static-method", "javadoc" }) public final class TrimmerTest {
  ...
  @Test public void booleanChangeValueOfToConstantNotConstant() {
    trimmingOf("Boolean.valueOf(expected);").stays(); // from junit source
  }
  ...
  @Test public void commonSuffixIfBranchesDisappearingThenWithinIf() {
    trimmingOf("if (x)  if (a) { \n" + //
        ...
        "++j;\n" + //
        "f();\n" + //
        "} else { h(); ++i; ++j; ++k; if (a) f(); else g(); }").gives("if (x) { if (!a)  \n" + //
            "++j;\n" + //
            "\n" + //
  ...
  @Test public void ifSequencerNoElseSequencer0() {
    trimmingOf("if (a) return; break;").stays();
  }
  ...
  @Test public void ifSequencerNoElseSequencer05() {
    trimmingOf("if (a) {x(); return;} continue;").stays();
  }
  ...
  @Test public void isGreaterTrue() {
    ...
    assert s.demandsToSuggestButPerhapsCant(e);
  ...
  @Test public void issue110_06() {
    trimmingOf("receiver ==null ? \"Use \" + \"x\" : \"Use \" + receiver")//
        .gives("\"Use \"+(receiver==null ? \"x\" : receiver)").stays();
  }
  ...
  @Test public void issue110_08() {
    trimmingOf("receiver ==null ? \"Use\" : receiver + \"Use\"")//
        .gives("(receiver==null ? \"\" : receiver+\"\") + \"Use\"").stays();
  }
  ...
  @Test public void issue131_1() {
    trimmingOf("for(int i=4 ; i<s.length() ; ++i){i+=9;i++;return xxx;}return xxx;")
        .gives("for(int i=4 ; i<s.length() ; ++i){i+=9;++i;break;}return xxx;");
  }

  @Test public void issue131_10() {
    trimmingOf("while(i>9)if(i==5)return xxx;return xxx;").gives("while(i>9)if(i==5)break;return xxx;");
  }

  @Test public void issue131_11() {
    trimmingOf("int t=5;int i=2;for(int i=4 ; i<s.length() ; ++i){if(i==5){t+=9;return xxx;}y+=15;return xxx;}return xxx;")
        .gives("int t=5;int i=2;for(int i=4 ; i<s.length() ; ++i){if(i==5){t+=9;return xxx;}y+=15;break;}return xxx;")
        .gives("int t=5;int i=2;for(int i=4 ; i<s.length() ; ++i){if(i==5){t+=9;break;}y+=15;break;}return xxx;");
  }

  @Test public void issue131_12() {
    trimmingOf("boolean b=false;for(int i=4 ; i<s.length() ; ++i){if(i==5){t+=9;return xxx;}else return tr;y+=15;return xxx;}return xxx;")
        .gives("boolean b=false;for(int i=4 ; i<s.length() ; ++i){if(i!=5)return tr;t+=9;return xxx;y+=15;return xxx;}return xxx;")
        .gives("boolean b=false;for(int i=4 ; i<s.length() ; ++i){if(i!=5)return tr;t+=9;break;y+=15;return xxx;}return xxx;")
        .gives("boolean b=false;for(int i=4 ; i<s.length() ; ++i){if(i!=5)return tr;t+=9;break;y+=15;break;}return xxx;");
  }

  @Test public void issue131_13() {
    trimmingOf("int i=1;while(i<7){if(i==5){t+=9;return xxx;}y+=15;return xxx;}return xxx;")
        .gives("int i=1;while(i<7){if(i==5){t+=9;return xxx;}y+=15;break;}return xxx;")
        .gives("int i=1;while(i<7){if(i==5){t+=9;break;}y+=15;break;}return xxx;");
  }

  @Test public void issue131_14() {
    trimmingOf("public static void main(){while(i<7){if(i==5){t+=9;return xxx;}else return tr;y+=15;return xxx;}return xxx;}")
        .gives("public static void main(){while(i<7){if(i!=5)return tr;t+=9;return xxx;y+=15;return xxx;}return xxx;}")
        .gives("public static void main(){while(i<7){if(i!=5)return tr;t+=9;break;y+=15;return xxx;}return xxx;}")
        .gives("public static void main(){while(i<7){if(i!=5)return tr;t+=9;break;y+=15;break;}return xxx;}");
  }

  @Test public void issue131_2() {
    trimmingOf("for(int i=4 ; i<s.length() ; ++i){i+=9;return xxx;}return xxx;").gives("for(int i=4 ; i<s.length() ; ++i){i+=9;break;}return xxx;");
  }

  @Test public void issue131_3() {
    trimmingOf("for(int i=4 ; i<s.length() ; ++i)return xxx;return xxx;").gives("for(int i=4 ; i<s.length() ; ++i)break;return xxx;");
  }

  @Test public void issue131_4() {
    trimmingOf("for(int i=4 ; i<s.length() ; ++i)if(t=4)return xxx;return xxx;").gives("for(int i=4 ; i<s.length() ; ++i)if(t=4)break;return xxx;");
  }

  @Test public void issue131_5() {
    trimmingOf("while(i>5){i+=9;i++;return xxx;}return xxx;").gives("while(i>5){i+=9;++i;break;}return xxx;");
  }

  @Test public void issue131_6() {
    trimmingOf("while(i>5){i+=9;return xxx;}return xxx;").gives("while(i>5){i+=9;break;}return xxx;");
  }

  @Test public void issue131_7() {
    trimmingOf("while(i>5)return xxx;return xxx;").gives("while(i>5)break;return xxx;");
  }

  @Test public void issue131_8() {
    trimmingOf("while(i>5)if(t=4)return xxx;return xxx;").gives("while(i>5)if(t=4)break;return xxx;");
  }

  @Test public void issue131_9() {
    trimmingOf("for(int i=4 ; i<s.length() ; ++i)if(i==5)return xxx;return xxx;").gives("for(int i=4 ; i<s.length() ; ++i)if(i==5)break;return xxx;");
  }
  ...
  public void issue39baseDual() {
    trimmingOf("if (name != null) {\n" + //
        ...
        "    return false;\n" + //
        "return true;").gives("if (name == null) {\n" + "    if (other.name != null)\n" + "        return false;\n"
            + "} else if (!name.equals(other.name))\n" + "    return false;\n" + "return true;");
  }
  ...
  @Test public void paramAbbreviateBasic1() {
    trimmingOf("void m(XMLDocument xmlDocument, int abcd) {" + //
        "xmlDocument.exec(p);}").gives("void m(XMLDocument d, int abcd) {" + //
            "d.exec(p);}");
  }
  ...
  @Test public void paramAbbreviateBasic2() {
    trimmingOf("int m(StringBuilder builder, int abcd) {" + //
        "if(builder.exec())" + //
        "builder.clear();").gives("int m(StringBuilder b, int abcd) {" + //
            "if(b.exec())" + //
            "b.clear();");
  }
  ...
  @Test public void paramAbbreviateConflictingWithLocal1() {
    trimmingOf("void m(String string) {" + //
        "String s = null;" + //
        "string.substring(s, 2, 18);}").gives("void m(String string){string.substring(null,2,18);}");
  }

  @Test public void paramAbbreviateConflictingWithLocal1Simplified() {
    trimmingOf("void m(String string) {" + //
        "String s = X;" + //
        "string.substring(s, 2, 18);}").gives("void m(String string){string.substring(X,2,18);}");
  }

  @Test public void paramAbbreviateConflictingWithLocal1SimplifiedFurther() {
    trimmingOf("void m(String string) {" + //
        "String s = X;" + //
        "string.f(s);}").gives("void m(String string){string.f(X);}");
  }
  ...
  @Test public void paramAbbreviateConflictingWithLocal2() {
    trimmingOf("TCPConnection conn(TCPConnection tcpCon) {" + //
        ...
        "   c.disconnect();}").gives("TCPConnection conn(TCPConnection tcpCon){" //
            + " if(tcpCon.isConnected())" //
  ...
  @Test public void paramAbbreviateMultiple() {
    trimmingOf("void m(StringBuilder stringBuilder, XMLDocument xmlDocument, Dog dog, Dog cat) {" + //
        ...
        "dog.eat(xmlDocument.asEdible(cat));}").gives("void m(StringBuilder b, XMLDocument xmlDocument, Dog dog, Dog cat) {" + //
            "b.clear();" + //
  ...
  @Test public void paramAbbreviateNestedMethod() {
    trimmingOf("void f(Iterator iterator) {" + //
        ...
        "@Override public Object next() { return null; } };").gives("void f(Iterator i) {" + //
  ...
  @Test public void postfixToPrefixAvoidChangeOnVariableDeclaration() {
    ...
    trimmingOf("int s = 2;" + //
        "int n = s++;" + //
        "S.out.print(n);").gives("int s=2;S.out.print(s++);");
  }
  ...
  @Test public void prefixToPostfixDecrement() {
    ...
    azzert.that(new PostfixToPrefix().demandsToSuggestButPerhapsCant(e), is(true));
  ...
  @Test public void pushdownTernaryintoPrintln() {
    trimmingOf("    if (s.equals(t))\n"//
        + "      S.h(Hey + res);\n"//
        + "    else\n"//
        + "      S.h(Ho + x + a);").gives("S.h(s.equals(t)?Hey+res:Ho+x+a);");
  }
  ...
  @Test public void rightSimplificatioForNulNNVariableReplacement() {
    ...
    assert w != null;
    assert w.demandsToSuggestButPerhapsCant(e);
  ...
  @Test public void shortestBranchIfWithComplexNestedIf6() {
    trimmingOf("if (a) {f(); g(); h(); ++i; f(); j++;} else if (a) ++i; else j++;").gives("if(!a)if(a)++i;else j++;else{f();g();h();++i;f();j++;}");
  }
  ...
  @Test public void sortAdditionThreeOperands3() {
    trimmingOf("1+2F+33+142+1").stays();
  }

  @Test public void sortAdditionThreeOperands4() {
    trimmingOf("1+2+'a'").stays();
  }
  ...
  @Test public void sortThreeOperands3() {
    trimmingOf("2*2F*33*142").stays();
  }

  @Test public void sortThreeOperands4() {
    trimmingOf("2*3*'a'").stays();
  }
  ...
  @Test public void ternarize05() {
    trimmingOf(" int res = 0; "//
        ...
        + "res += 6;   "//
        + "else    "//
        + "res += 9;      ").gives("int res=0;res+=s.equals(532)?6:9;");
  }
  ...
  @Test public void ternarize05a() {
    trimmingOf(" int res = 0; "//
        ...
        + "else    "//
        + "res += 9;      "//
        + "return res; ").gives("int res=0;res+=s.equals(532)?6:9;return res;");
  }
  ...
  @Test public void ternarize10() {
    trimmingOf("String res = s, foo = bar;   "//
        ...
        + "res = s + 0xABBA;   "//
        + "S.h(res); ").gives("String res=s.equals(532)==true?s+0xABBA:s,foo=bar;S.h(res);");
  }
  ...
  @Test public void ternarize55() {
    trimmingOf("if (key.equals(markColumn))\n" + //
        ...
        "else\n" + //
        "  to.put(key, missing(key, a) ? Z2 : get(key, a));").gives("to.put(key,key.equals(markColumn)?a.toString():missing(key,a)?Z2:get(key,a));");
  }
  ...
  @Test public void useOutcontextToManageStringAmbiguity() {
    trimmingOf("1+2+s<3").gives("s+1+2<3");
  }
