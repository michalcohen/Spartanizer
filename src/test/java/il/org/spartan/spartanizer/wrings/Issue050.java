...
@FixMethodOrder(MethodSorters.NAME_ASCENDING) @SuppressWarnings({ "static-method", "javadoc" }) public class Issue050 {
  ...
  @Test public void A$50b_interface() {
    trimmingOf("abstract static interface a {}").gives("interface a {}");
  }
  ...
  @Test public void A$50c_interface_static_abstract() {
    trimmingOf("static abstract interface a {}").gives("interface a {}");
  }

  @Test public void A$50d_interface() {
    trimmingOf("static interface a {}").gives("interface a {}");
  }
  ...
  @Test public void A$50f_enum() {
    trimmingOf("static enum a {a, b}").gives("enum a {a, b}");
  }

  @Test public void A$50g_enum() {
    trimmingOf("static abstract enum a {x,y,z; void f() {}}").gives("enum a {x,y,z; void f() {}}");
  }

  @Test public void A$50h_enum() {
    trimmingOf("static abstract final enum a {x,y,z; void f() {}}").gives("enum a {x,y,z; void f() {}}");
  }
}
