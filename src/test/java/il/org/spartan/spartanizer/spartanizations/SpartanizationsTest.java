...
//  String fileTestPath = "/home/matteo/MUTATION_TESTING/test-spartan-cl/projects/commons-lang/"+
...
//    final IProject p = ResourcesPlugin.getWorkspace().getRoot().getProject("spartanTestTemp");
//    if (p.exists())
//      p.delete(true, null);
//    p.create(null);
//    p.open(null);
