...
/**
 * Unit test for:
 *   - {@link MethodDeclarationRenameReturnToDollar}
 *   - {@link MethodDeclarationRenameSingleParameterToCent}
 * Checks \@param tag value in javadoc is changed with dollar/cent renaming.
 * @author Ori Roth
 * @since 2016
 * @see SingleVariableDeclarationAbbreviation#fixJavadoc
 * TODO Ori: add testing for comments
 */
