# Spartan Refactoring [![Build Status](https://travis-ci.org/mittelman/spartan-refactoring.svg?branch=master)](https://travis-ci.org/mittelman/spartan-refactoring)
