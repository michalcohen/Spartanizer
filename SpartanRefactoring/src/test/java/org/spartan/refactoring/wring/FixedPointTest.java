...
public class FixedPointTest {
  ...
  @Test(timeout = 100) public void chainComparison() {
  ...
  @Test(timeout = 100) public void eliminateRedundantIf4() {
    assertConvertsTo("{if (a) {;}} ", "");
  }
  @Test(timeout = 100) public void longChainComparison() {
    assertNoChange("a == b == c == d");
  }
  @Test(timeout = 100) public void longChainParenthesisComparison() {
    assertNoChange("(a == b == c) == d");
  }
  @Test(timeout = 100) public void longChainParenthesisNotComparison() {
    assertNoChange("(a == b == c) != d");
  }
  @Test(timeout = 100) public void longerChainParenthesisComparison() {
    assertNoChange("(a == b == c == d == e) == d");
  }
  @Test(timeout = 100) public void multipleIfDeclarationAssignment() {
    assertConvertsTo(//
        "int a, b;a = 3;b = 5;if (a == 4)  if (b == 3) b = 2;else          b = a;else if (b == 3)         b = 2;else         b = a*a;",
        "int a =3, b=5; b=a==4?b==3?2:a:b==3?2:a*a;");
  }
  @Test(timeout = 100) public void shorterChainParenthesisComparison() {
    assertNoChange("a == b == c");
  }
  @Test(timeout = 100) public void shorterChainParenthesisComparisonLast() {
    assertNoChange("b == a * b * c * d * e * f * g * h == a");
  }
  @Test(timeout = 100) public void shortestIfBranchFirst02() {
    assertConvertsTo(
        "" //
            + "if (!s.equals(0xDEAD)) { "//
            + " int res=0;"//
  ...
  @Test(timeout = 100) public void shortestIfBranchFirst03() {
    assertConvertsTo(
        "  if (s.length() > 6) {\n" + //
            "      int res = 0;\n" + //
            "      for (int i = 0;i < s.length();i++)\n" + //
  ...
  @Test(timeout = 100) public void shortestIfBranchFirst03a() {
    assertConvertsTo(
        "  if ('a' == s.charAt(i))\n" + //
            "          res += 2;\n" + //
            "        else if ('d' == s.charAt(i))\n" + //
  ...
  @Test(timeout = 100) public void shortestIfBranchFirst03b() {
    assertConvertsTo(
        "    if (s.length() > 6) {\n" + //
            "      int res = 0;\n" + //
            "      for (int i = 0; i < s.length(); ++i)\n" + //
  ...
  @Test(timeout = 100) public void shortestIfBranchFirst04() {
    assertConvertsTo(
        "    String s;\n" + //
            "    if (s.length() >= 6) {\n" + //
            "      int res = 0;\n" + //
  ...
  @Test(timeout = 100) public void shortestIfBranchFirst09() {
    assertSimplifiesTo("s.equals(532) ? 9 * yada3(s.length()) : 6 ", "!s.equals(532)?6:9*yada3(s.length())");
  }
  @Test(timeout = 100) public void shortestIfBranchFirst10() {
    assertConvertsTo(
  ...
  @Test(timeout = 100) public void shortestIfBranchFirst11() {
  ...
  @Test(timeout = 100) public void shortestIfBranchFirst12() {
  ...
  @Test(timeout = 100) public void shortestOperand01() {
    assertNoChange("x + y > z");
  }
  @Test(timeout = 100) public void shortestOperand03() {
    assertConvertsTo(//
        "k = k * 4;if (1 + 2 - 3 - 4 + 5 / 6 - 7 + 8 * 9 > 4+k) return true;", //
        "k=4*k;if(5 / 6+8*9+1+2-3-4-7>k+4)return true;");
  }
  @Test(timeout = 100) public void shortestOperand04() {
  ...
  @Test(timeout = 100) public void shortestOperand08() {
    assertConvertsTo(//
  ...
  @Test(timeout = 100) public void shortestOperand09() {
    assertNoChange("return 2 - 4 < 50 - 20 - 10 - 5;} ");
  }
  @Test(timeout = 100) public void shortestOperand10() {
    assertNoChange("return b == true;} ");
  }
  @Test(timeout = 100) public void shortestOperand11() {
    assertNoChange("int h,u,m,a,n;return b == true && n + a > m - u || h > u;");
  }
  @Test(timeout = 100) public void shortestOperand26() {
    assertConvertsTo("return f(a,b,c,d) | f() | 0;} ", "return f()|f(a,b,c,d)|0;}");
  }
  @Test(timeout = 100) public void shortestOperand35() {
    assertConvertsTo("return f(a,b,c,d) * moshe; ", "   return moshe * f(a,b,c,d);");
  }
  @Test(timeout = 100) public void sortAddition5() {
    assertSimplifiesTo("1 + 2  + 3 + a < 3 -4", "a + 1 + 2 + 3 < 3-4");
  }
  @Test(timeout = 100) public void ternarize01() {
    assertConvertsTo(//
  ...
  @Test(timeout = 100) public void ternarize02() {
    assertConvertsTo(//
  ...
  @Test(timeout = 100) public void ternarize03() {
    assertConvertsTo(//
  ...
  @Test(timeout = 100) public void ternarize11() {
  ...
  @Test(timeout = 100) public void ternarize15() {
  ...
  @Test(timeout = 100) public void ternarize17() {
