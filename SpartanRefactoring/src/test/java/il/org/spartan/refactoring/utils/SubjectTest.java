...
@SuppressWarnings({ "javadoc", "static-method" }) public class SubjectTest {
  ...
  @Test public void extractcoreLeft() {
    azzert.that(Subject.pair(e("((a-B))"), e("c-d")).to(PLUS), iz("a - B + c - d"));
  }
  ...
  @Test public void operandsNoParenthesisRest() {
    azzert.that(Subject.operands(e("((a))"), e("b+c"), e("c+d")).to(PLUS), iz("a+b+c+c+d"));
  }
  ...
  @Test public void operandsVanilla() {
    azzert.that(Subject.operands(e("((a))"), e("b"), e("c")).to(PLUS), iz("a+b+c"));
  }
  ...
  @Test public void subjectOperandsNotNull() {
    azzert.that(Subject.operands(extract.operands(Funcs.duplicate(i("a+b+c")))).to(i("1+2+3").getOperator()), notNullValue());
  }
