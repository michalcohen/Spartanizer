...
public final class IfReturnNoElseReturn extends Wring.ReplaceToNextStatement<IfStatement> {
  @Override ASTRewrite go(final ASTRewrite r, final IfStatement s, final Statement nextStatement, final TextEditGroup g) {
    if (!Is.vacuousElse(s))
      return null;
    final ReturnStatement r1 = returnStatement(then(s));
    if (r1 == null)
      return null;
    final Expression e1 = core(r1.getExpression());
    if (e1 == null)
      return null;
    final ReturnStatement r2 = returnStatement(nextStatement);
    if (r2 == null)
      return null;
  ...
  @Override boolean scopeIncludes(final IfStatement s) {
    return Is.vacuousElse(s) && returnStatement(then(s)) != null && nextReturn(s) != null;
  }
