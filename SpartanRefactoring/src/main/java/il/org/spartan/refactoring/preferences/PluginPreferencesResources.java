...
public class PluginPreferencesResources {
	...
	public static final boolean getResolveBindingEnabled() {
		return Plugin.getDefault() != null
				&& Plugin.getDefault().getPreferenceStore().getBoolean(ENABLE_BINDING_RESOLUTION_ID);
	}
	...
	public enum WringGroup {
		...
		/**
		 * Queries the plugin's preferences store and retrieves whether the
		 * wring group is currently enabled by the user
		 *
