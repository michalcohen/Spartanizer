...
public interface Funcs { 
  ...
  static String shortName(final Type t) {
    return t instanceof NameQualifiedType ? shortName((NameQualifiedType) t) : t instanceof PrimitiveType ? shortName((PrimitiveType) t) : t instanceof QualifiedType ? shortName((QualifiedType) t)
        : t instanceof SimpleType ? shortName((SimpleType) t) : t instanceof WildcardType ? shortName((WildcardType) t) : t instanceof ArrayType ? shortName((ArrayType) t)
