...
public enum extract {
  ...
  @SuppressWarnings("unchecked") public static List<Expression> dimensions(final ArrayCreation c) {
    return c.dimensions();
  }
  ...
  public static List<Expression> expressions(final ArrayCreation c) {
