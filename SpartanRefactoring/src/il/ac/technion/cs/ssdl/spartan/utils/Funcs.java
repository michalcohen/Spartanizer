...
public enum Funcs {
	...
	/**
	 * @param t
	 *            the AST who is to own the new parenthesized conditional
	 *            expression
	 * @param r
	 ...
	 * @return 0 is s is null, 1 if s is a statement or the number of statement
	 *         in the block is s is a block
	 */
	 ...
	 * @return true if one of the nodes is an Expression Statement of type Post
	 *         or Pre Expression with ++ or -- operator. false if none of them
	 *         are or if the given parameter is null.
	 */
	...
	public static boolean isNodeIncOrDecExp(final ASTNode n) {
		...
		case ASTNode.PREFIX_EXPRESSION:
			return in(((PrefixExpression) n).getOperator(), PrefixExpression.Operator.INCREMENT,
	 ...
	 * @param n
	 *            node to check
	 * @return true if the given node is a variable declaration statement or
	 *         false otherwise
	 */
