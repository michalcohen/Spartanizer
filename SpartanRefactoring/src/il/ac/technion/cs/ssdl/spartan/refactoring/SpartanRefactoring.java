 ...
 * @since 2013/01/01
 */
public abstract class SpartanRefactoring extends Refactoring {
   ...
   */
  protected SpartanRefactoring(final String name, final String message) {
    this.name = name;
  ...
  public class SpartanizationResolution implements IMarkerResolution {
    @Override public String getLabel() {
      return SpartanRefactoring.this.toString() + ": Do it!";
    }
  ...
  public class SpartanizationResolutionWithPreview implements IMarkerResolution {
    @Override public String getLabel() {
      return SpartanRefactoring.this + ": Show me a preview first";
    }
    
    @Override public void run(final IMarker m) {
      setMarker(m);
      try {
        new RefactoringWizardOpenOperation(new SpartanRefactoringWizard(SpartanRefactoring.this)).run(Display.getCurrent()
            .getActiveShell(), "Spartan Refactoring: " + SpartanRefactoring.this);
