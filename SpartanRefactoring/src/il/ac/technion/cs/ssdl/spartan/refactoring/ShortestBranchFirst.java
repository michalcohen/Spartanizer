...
public class ShortestBranchFirst extends Spartanization {
	...
	@Override
	protected final void fillRewrite(final ASTRewrite r, final AST t, final CompilationUnit cu, final IMarker m) {
	...
	private static Expression negateExp(final AST t, final ASTRewrite r, final Expression exp) {
		...
		return isPrefix(exp) && ((PrefixExpression) exp).getOperator().equals(NOT) ? 
