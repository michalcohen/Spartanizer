	...
	public IMarkerResolution[] getResolutions(final IMarker arg0) {
		try {
			final String spartanizationName = (String) arg0
					.getAttribute(SpartaBuilder.SPARTANIZATION_TYPE_KEY);
			return new IMarkerResolution[] {
					SpartanizationFactory.getSpartanizationByName(
							spartanizationName).getFix(),
					SpartanizationFactory.getSpartanizationByName(
							spartanizationName).getFixWithPreview() };
