 ...
 * </pre>
 * 
 *         TODO: There <b>must</b> be an option to disable this warning in
 *         selected places. Consider this example:
 * 
 *         <pre>
 ...
 * </pre>
 * 
 *         You should not inline the variable t, and you should not move forward
 *         its declaration! Some alternatives for disabling the warning are:
 *         First, a dedicated annotation of name such as $Resident or
